...
using AlarmClock.AlarmClock.Code.Utilities;
using KSP.Game;
...
namespace AlarmClock.AlarmClock.Code.UI.Components
{
    public class TransferWindowContext : ContextElement
    {
        ...
        public TransferWindowContext(Action<int> swapContext, Func<SettingsInfo> getSettings) : base(swapContext, "UI/TransferWindowMenu.uxml")
        {
